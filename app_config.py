...
app_config['service']['acheta_release_url'] = "https://api.github.com/repos/Soulthym/massa_acheta/releases/latest"
...
app_config['service']['massexplo_api_url'] = "https://api.massexplo.com/info?network=MainNet"
